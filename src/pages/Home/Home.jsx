      ...
      <section className='Section2'>
        ...
        <section className='px-[20px] lg:px-[150px] py-[50px]'>
          ...
          <div className='flex flex-wrap justify-center items-center gap-[20px] lg:justify-between'>
            <div className='flex flex-col gap-[20px]'>
              <article data-aos='zoom-in' className='text-center px-[40px] py-[40px] items-center flex flex-col justify-between w-[300px] hover:shadow-lg dark:shadow-[#ffffff38] shadow-gray-600  h-[200px] rounded-[4px] border-[1px] dark:border-gray-700 border-[#E5E8ED]'>
